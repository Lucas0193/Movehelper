...
class BaseTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        uncertificated_user = UserAccount(email='uncertificated@movehelper.com', username='uncertificated', confirmed=True, certificated=False)
        ...
        normal_task = UserTasks(id='1', title='task1', context='text1', contact='contact1', location='location1', manpower='1')
        closed_task = UserTasks(id='2', title='task2', context='text2', contact='contact2', location='location2', manpower='1', status=True)
